...
2. Reboot the AP. If the AP's console is nonresponsive, reset the AP to force a reboot.
...
the [BDB1B Setup](Big-Development-Board-(BDB)-Version-1-Rev-B-Orientation-and-Setup).  When using a Jetson TK1 as your AP, you will connect to the main USB port on your Jetson, as circled in green here:
