...
When using a Jetson TK1 as an AP, you have the option of [loading a pre-built flash image](https://github.com/projectara/Android-wiki/wiki/Build-and-Boot-Instructions-for-Jetson-reference-platform).  With this image flashed to your Jetson TK1, the Greybus kernel modules are available in the /lib/modules directory.
