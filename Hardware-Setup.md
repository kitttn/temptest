This page provides details on setting up your BDB and JTAG hardware.  If you're not using JTAG, you can skip the parts about connecting the J-Link JTAG interface.  
