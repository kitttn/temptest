...
As the result of following the procedure detailed above, your setup should now match the bird's eye that we provided towards the top of the present page:
![BDB1B Setup Bird's-Eye View](images/BDB1B-Setup-Birds-Eye-View.png)
