The developer release includes a [tarball](http://storage.googleapis.com/mdk/unipro_bridge_firmware_devcon2_v0.2.tar.gz) with the necessary source and tools to build firmware for APBridge1 and AP Bridge 2.
