...
To start, you'll want to create a working directory and then untar the contents of the tarball (these instructions assume the tarball is in `$HOME/devcon2_v0.2.tar.gz`):
